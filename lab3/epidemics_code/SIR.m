...
param.r = 1e-6;    % set the parameter 'r' of the model

% This is the title string for the plot window.
model_title = 'SIR Epidemics, r=1e-6';
...
%
initial.S = 530;	% set the initial value of 'S'
initial.I = 13;	% set the initial value of 'I'
